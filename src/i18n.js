  ...
  en: {
    translation: {
      ...
      itemDownload: {
        ...
        iosTitle: "iPhone app",
        iosText: "Open the App Store to download SawaSwap for iPhone.",
      ...
      admin: {
        ...
        dashboard: {
          ...
          heroTitle: "Responsive control room for listings, reports, users, and live conversations.",
          heroText:
            "Tables are sortable and filterable by column. Add, edit, and view actions open in drawers, and message threads open as chat instead of raw rows.",
          liveBadge: "live",
          tableBadge: "table",
          tableFallback: "Table",
        },
        nav: {
          title: "Sections",
          dashboard: "Dashboard",
          dashboardMeta: "Overview, queues, health",
          openMenu: "Open menu",
        ...
        overview: {
          ...
          text: "A responsive overview of moderation load, trading activity, and items waiting for action.",
          messages: {
            loadError: "Failed to load dashboard snapshot.",
          },
          cards: {
            newItems: { title: "New items", hint: "Listed in the last 7 days" },
            pendingItems: { title: "Pending item review", hint: "Live queue needing acceptance" },
            openReports: { title: "Open reports", hint: "{{count}} older than 24h" },
            pendingOffers: { title: "Pending offers", hint: "Trade offers waiting for admin review" },
            rejectedItems: { title: "Rejected items", hint: "Listings already declined" },
            newUsers: { title: "New users", hint: "Profiles created this week" },
            activeMatches: { title: "Active matches", hint: "Conversations still in progress" },
            adminAccounts: { title: "Admin accounts", hint: "{{count}} profiles total" },
          },
          recentReports: {
            title: "Recent reports",
            text: "Open the reports table to sort, filter, and resolve.",
            cta: "Open reports",
          },
          recentItems: {
            title: "Recent items",
            text: "Jump to items to approve, reject, or edit listings.",
            cta: "Open items",
          },
        },
        panel: {
        ...
        messages: {
          ...
          createError: "Failed to create {{resource}}.",
          ...
          auditDeleteDisabled: "Delete is disabled for audit tables.",
          ...
          reviewReasonNotFound: "Review reason code \"{{code}}\" was not found in item_review_reasons.",
          signOutError: "Failed to sign out.",
          unknownUser: "Unknown user",
          unknownReason: "Unknown reason",
          noDetails: "No details",
          imagePreviewAlt: "Preview {{index}}",
        },
        conversation: {
          loading: "Loading messages...",
          empty: "No messages found.",
          loadError: "Failed to load messages.",
          subtitleFallback: "Conversation",
          unknownInitial: "U",
        },
        grid: {
          ...
          footerPaginationDisplayedRows: "{{from}}-{{to}} of {{count}}",
        },
        form: {
          select: "Select",
        },
    ...
    translation: {
      ...
      admin: {
        ...
        dashboard: {
          ...
          heroTitle: "غرفة تحكم مرنة للإعلانات والبلاغات والمستخدمين والمحادثات المباشرة.",
          heroText:
            "يمكن فرز الجداول وتصفيتها حسب الأعمدة. تفتح إجراءات الإضافة والتعديل والعرض داخل أدراج جانبية، وتظهر سلاسل الرسائل كمحادثات بدل الصفوف الخام.",
          liveBadge: "مباشر",
          tableBadge: "جدول",
          tableFallback: "جدول",
        },
        nav: {
          ...
          dashboardMeta: "نظرة عامة، طوابير، حالة النظام",
          openMenu: "فتح القائمة",
          closeMenu: "إغلاق القائمة",
        },
        overview: {
          ...
          title: "لوحة تحكم الإدارة",
          text: "نظرة سريعة متجاوبة على عبء المراجعة ونشاط المبادلات والعناصر التي تنتظر إجراءً.",
          messages: {
            loadError: "تعذر تحميل ملخص لوحة التحكم.",
          },
          cards: {
            newItems: { title: "عناصر جديدة", hint: "أُدرجت خلال آخر 7 أيام" },
            pendingItems: { title: "عناصر بانتظار المراجعة", hint: "قائمة حالية تحتاج قبولاً" },
            openReports: { title: "بلاغات مفتوحة", hint: "{{count}} أقدم من 24 ساعة" },
            pendingOffers: { title: "عروض معلقة", hint: "عروض المبادلة التي تنتظر مراجعة الإدارة" },
            rejectedItems: { title: "عناصر مرفوضة", hint: "إعلانات تم رفضها مسبقاً" },
            newUsers: { title: "مستخدمون جدد", hint: "ملفات شخصية أُنشئت هذا الأسبوع" },
            activeMatches: { title: "مطابقات نشطة", hint: "محادثات لا تزال جارية" },
            adminAccounts: { title: "حسابات الإدارة", hint: "إجمالي الملفات الشخصية {{count}}" },
          },
          recentReports: {
            title: "أحدث البلاغات",
            text: "افتح جدول البلاغات للفرز والتصفية والمعالجة.",
            cta: "فتح البلاغات",
          },
          recentItems: {
            title: "أحدث العناصر",
            text: "انتقل إلى العناصر للموافقة أو الرفض أو تعديل الإعلانات.",
            cta: "فتح العناصر",
          },
        },
        panel: {
        ...
        messages: {
          ...
          createError: "تعذر إنشاء {{resource}}.",
          updateError: "تعذر تحديث {{resource}}.",
          requiredField: "{{field}} مطلوب.",
          deleteError: "تعذر الحذف من {{resource}}.",
          deleteConfirm: "هل تريد حذف هذا السجل من {{resource}}؟\n\n{{id}}",
          auditDeleteDisabled: "الحذف معطل في جداول التدقيق.",
          ...
          reviewReasonRequired: "سبب المراجعة مطلوب.",
          reviewReasonNotFound: "رمز سبب المراجعة \"{{code}}\" غير موجود في item_review_reasons.",
          signOutError: "تعذر تسجيل الخروج.",
          unknownUser: "مستخدم غير معروف",
          unknownReason: "سبب غير معروف",
          noDetails: "لا توجد تفاصيل",
          imagePreviewAlt: "معاينة {{index}}",
        },
        conversation: {
          loading: "جارٍ تحميل الرسائل...",
          empty: "لا توجد رسائل.",
          loadError: "تعذر تحميل الرسائل.",
          subtitleFallback: "المحادثة",
          unknownInitial: "م",
        },
        grid: {
          ...
          footerRowSelected: "تم تحديد {{count}} صف",
          footerTotalRows: "إجمالي الصفوف:",
          footerPaginationRowsPerPage: "عدد الصفوف في الصفحة:",
          footerPaginationDisplayedRows: "{{from}}-{{to}} من {{count}}",
        },
        form: {
          select: "اختر",
        },
